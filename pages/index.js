            ...
            <div className="p-6 space-y-4 md:space-y-6 sm:p-8 text-center m-7">
              ...
              <form className="space-y-4 md:space-y-6" action="#">
                ...
                <div className="flex justify-center my-4">
                  ...
                  cursor-pointer w-full bg-[#5E3B76] rounded p-4">Login</button>
                </div>
              </form>
              <div className='border-2 border-dashed rounded-xl cursor-pointer p-4 flex flex-col text-center bg-cyan-100 border-sky-400 text-cyan-600'>
